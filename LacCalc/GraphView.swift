...
@IBDesignable class GraphView: UIView {
    ...
    override func drawRect(rect: CGRect) {
        let minimumValue:Int = yPoints.minElement()!
        for n in 0..<yPoints.count {
            yPoints[n] -= minimumValue
        }
        let minimumXValue:Int = xPoints.minElement()!
        ...
        let maxXValue = xPoints.maxElement()
        ...
        let maxValue = yPoints.maxElement()
        ...
        graphPath.moveToPoint(CGPoint(x: columnXPoint(xPoints[0]), y: columnYPoint(yPoints[0])))
        ...
        clippingPath.addLineToPoint(CGPoint(x: columnXPoint(yPoints.count - 1), y: height))
